...
#this script need a serial translator sketch to be uploaded to the arduino board. the sketch is a .ino file that is included in the repository. -ABQ
...
#this sets length of and the timespan bewtween each blink of the built-in L led on the arduino board. -ABQ
